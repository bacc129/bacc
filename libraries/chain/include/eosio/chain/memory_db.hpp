...
FC_REFLECT(eosio::chain::memory_db::bp_info, (name)(invite)(producer_key)
            (total_staked)(rewards_pool)(rewards_block)
            (total_voteage)(voteage_update_height)(url)(emergency)(isactive)(pawn))
