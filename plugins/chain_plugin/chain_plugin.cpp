 ...
 * string contract: contract name (eg: System, bacc.token)
...
void chain_plugin::plugin_initialize(const variables_map& options) {
   ...
   try {
      ...
      load_contract_code_abi("noc.system", my->chain_config->system_code, my->chain_config->system_abi);
      load_contract_code_abi("noc.token", my->chain_config->token_code, my->chain_config->token_abi);
      load_contract_code_abi("noc.msig", my->chain_config->msig_code, my->chain_config->msig_abi);
